...
void startPage() {
  ...
  // TODO : change start word
  displaySnakeWord(13,7, Glooming);

  // TODO : change mock players with blobs
...
// TODO : moving speed doesnt make sense anymore (Just avoid going too fast?)
...
void initializePlayers() {
  ...
  if(players[0].isActive == 1) {
    ...
    for(byte bodyIndex = 1; bodyIndex < maxBlobSize; bodyIndex++) {
